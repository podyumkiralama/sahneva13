...
const service = RUSSIAN_SERVICE_PAGES["led-screen-rental"];
const canonical = buildCanonical(service.href);

export const metadata = {
  title: service.title,
  description: service.description,
  alternates: buildAlternatesForPath("/ru/led-screen-rental"),
  openGraph: {
    title: service.title,
    description: service.description,
    url: canonical,
...
export default function RussianLedScreenRentalPage() {
