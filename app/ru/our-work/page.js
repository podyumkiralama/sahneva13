...
const PAGE_DESCRIPTION =
  "Реализованные проекты Sahneva: аренда сцен, LED-экранов, подиумов, звука и света, шатры и корпоративные мероприятия — с видео с площадок.";
...
const PROJECT_VIDEOS = [
  {
    ...
    description:
      "Видео с площадки: монтаж сцены, LED-экрана, звука и света для главной сцены фестиваля Sıfır Atık.",
  ...
  {
    id: "x-BYu0vgO2E",
    title: "SAHA 2026 — оформление специальной выставочной площадки",
    description:
      "Видео с закрытой выставочной площадки: индивидуальные конструкции, входная группа, напольная инфраструктура, купольный шатёр и атмосферное освещение.",
    services: ["Купольный шатёр", "Выставочная площадка", "Напольное покрытие", "Свет"],
  ...
  {
    id: "CVdYV5BkF3k",
    title: "Лазерная проекционная анимация в купольном шатре",
    description:
      "Видео с мероприятия: лазерная и проекционная анимация на внутренней поверхности купольного шатра.",
    services: ["Купольный шатёр", "Проекция", "Лазерная анимация", "Свет"],
  ...
  },
  {
    ...
    description:
      "Видео показывает совместную работу сцены, LED-экрана и технической команды на презентации Dicle Elektrik в Батмане.",
  ...
  {
    id: "4ygMbL4FDRc",
    title: "Шатёр TÜBİTAK «Космическая наука» — TEKNOFEST",
    description:
      "Видео монтажа конструкции и технического обеспечения шатра TÜBİTAK «Космическая наука» на TEKNOFEST.",
    services: ["Шатёр", "TEKNOFEST", "Площадка мероприятия", "Техническое обеспечение"],
  ...
  {
    id: "7yjrrEtWrr0",
    title: "Внутреннее оформление шатра TEKNOFEST и техническая инфраструктура",
    description:
      "Видео из шатровой зоны TEKNOFEST: внутреннее оформление, звуковая система, LED-экран, расстановка столов и стульев, техническая инфраструктура.",
    services: ["Шатёр", "Оформление", "LED-экран", "Звуковая система", "Столы и стулья"],
  ...
  {
    id: "_9Q7v0ZL304",
    title: "Монтаж сцены, LED-экрана, звука и света на TEKNOFEST",
    description:
      "Видео с площадки показывает интеграцию сцены, LED-экрана, звука, света и технической инфраструктуры на TEKNOFEST.",
    services: ["Сцена", "LED-экран", "Звук", "Свет"],
  ...
  {
    id: "c72ILTyJH4A",
    title: "Муниципалитет Фатих — Мероприятие «400 проектов за 5 лет»",
    description:
      "Видео с площадки: монтаж сцены, LED-экрана, звука и света, а также техническое обеспечение мероприятия муниципалитета Фатих.",
    services: ["Корпоративное мероприятие", "Сцена", "LED-экран", "Звук и свет"],
  ...
  },
  {
    ...
    description:
      "Видео с площадки: монтаж сцены, LED-экрана, звука, света и подиума, а также техническое обеспечение финала PUBG Türkiye 2023.",
    services: ["Киберспорт", "Сцена", "LED-экран", "Звук и свет"],
  ...
  {
    id: "1R5Av0x5ouA",
    title: "Репетиции сцены, LED-экрана и света для PUBG",
    description:
      "Видео технических репетиций сцены, LED-экрана и света, подготовленных для мероприятия PUBG.",
    services: ["Киберспорт", "Сцена", "LED-экран", "Свет"],
  ...
  {
    id: "i-KtuiLiBmI",
    title: "Аренда кубического LED-экрана",
    description:
      "Применение LED-экрана в форме куба в оформлении сцены и брендовой зоны мероприятия.",
    services: ["Кубический LED-экран", "LED-экран", "Дизайн сцены", "Техническое обеспечение"],
  ...
  {
    id: "AihkXPzPBi0",
    title: "LED-экран на корпоративном совещании",
    description:
      "Видео корпоративной сцены: LED-экран, подача презентации, видимость фирменной символики и техническое обеспечение.",
    services: ["Корпоративное мероприятие", "LED-экран", "Совещание", "Техническое обеспечение"],
  ...
  {
    id: "tyb1lG9KtiA",
    title: "Монтаж шатра и подготовка площадки",
    description:
      "Видео монтажа шатра: несущая конструкция, покрытие, крепления и координация команды на площадке.",
    services: ["Шатёр", "Монтаж", "Крепление", "Команда на площадке"],
  ...
  {
    id: "xatodgyZ_S8",
    title: "Гала «За горизонтом» и выставка первой пилотируемой миссии Турции",
    description:
      "Видео монтажа сцены, LED-экрана и выставочной площадки для гала-программы «За горизонтом» и выставки, посвящённой первой пилотируемой космической миссии Турции.",
    services: ["Гала-программа", "Выставочная площадка", "LED-экран", "Техническое обеспечение"],
  ...
  },
  {
    ...
    description:
      "Видео монтажа сцены, LED-экрана и пневматической купольной конструкции для презентации Национальной космической программы TUA.",
    services: ["Презентация", "Пневматический купол", "LED-экран", "Сцена"],
  ...
  {
    id: "qiqiBN4Uhu4",
    title: "Конгресс EAACI в Стамбуле — монтаж 360° LED-экрана для Leti Pharma",
    description:
      "Видео монтажа 360-градусной LED-конструкции для Leti Pharma на конгрессе EAACI в Стамбуле. Замкнутая экранная поверхность создала цельное иммерсивное бренд-пространство на выставочной площадке.",
    services: ["360° LED-экран", "LED-экран", "Корпоративное мероприятие", "Конгресс", "Выставка"],
...
export const metadata = {
  ...
  alternates: buildAlternatesForPath("/ru/our-work"),
  openGraph: {
    type: "website",
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    ...
    "@graph": [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Наши работы", item: PAGE_URL },
        ],
      },
      {
        "@type": "ItemList",
        "@id": `${PAGE_URL}#video-list`,
        name: "Список видео наших работ Sahneva",
...
export default function OurWorkRuPage() {
    ...
    <div className="min-h-screen overflow-hidden bg-[#0B1120] text-white">
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pb-20 lg:pt-36">
        ...
        <div className="relative mx-auto max-w-7xl">
          <nav aria-label="Хлебные крошки" className="mb-8 flex flex-wrap items-center gap-2 text-sm text-white/65">
            <Link href="/ru" className="transition hover:text-white">Главная</Link>
            <span aria-hidden="true">/</span>
            <span className="font-semibold text-white">Наши работы</span>
          </nav>

          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              <SectionEyebrow>Витрина видеопроектов</SectionEyebrow>
              <h1 className="mt-6 max-w-4xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
                Реализованные проекты сцен, LED-экранов и организации мероприятий
              </h1>
              <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300 md:text-xl">
                Здесь собраны видео реализованных проектов: монтаж сцен, LED-экранов,
                звука, света, ферм, подиумов и шатров на реальных площадках мероприятий.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                >
                  Получить предложение для похожего проекта
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:px-8" aria-labelledby="video-gallery-title">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <SectionEyebrow>Видеогалерея</SectionEyebrow>
              <h2 id="video-gallery-title" className="mt-4 text-3xl font-black tracking-tight md:text-5xl">
                От монтажа до дня мероприятия — реальные проекты на площадках
              </h2>
            </div>
          </div>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-black text-violet-100">
                  ...
                  Архив проектов Sahneva
                </div>
                <h2 className="text-3xl font-black tracking-tight md:text-4xl">
                  Давайте спланируем похожую установку для вашего мероприятия.
                </h2>
                <p className="mt-4 max-w-3xl text-base leading-relaxed text-slate-300 md:text-lg">
                  Мы предоставляем комплексные решения для концертов, фестивалей,
                  корпоративных мероприятий, презентаций продуктов и проектов на открытом
                  воздухе: сцена, LED-экран, подиум, звук, свет, фермы и шатёр у одного
