...
const PROJECT_GROUPS = [
  {
    ...
    text: "Корпоративные конференции, презентации и выставки с Absen P1.9 для близкого просмотра, а также LED-экраны для открытых площадок.",
    image: "/img/galeri/led-ekran-kiralama-1.webp",
  },
  {
    title: "Фестивали и концерты",
    text: "Сцены, ферменные конструкции, звук, свет и техническая команда для насыщенной программы мероприятий.",
    image: "/img/sahne/galeri-1.webp",
  },
  {
    title: "Шатры и площадки",
    text: "Купольные шатры, шатры-пагоды и большепролётные конструкции с мебелью, освещением и логистикой.",
...
export const metadata = {
  ...
  description:
    "Примеры проектов Sahneva: сцены, LED-экраны, звук, свет, ферменные конструкции, шатры и комплексная техническая подготовка мероприятий.",
      ...
      <section>
        <div className="mx-auto mb-8 max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-8 text-slate-700">
            Сцены, LED-экраны, звук, свет, ферменные конструкции и шатры — снимки с
            монтажа и в день мероприятия в разных городах Турции.
          </p>
        </div>
