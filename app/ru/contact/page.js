...
const BRIEF_ITEMS = [
  ...
  "Нужны ли сцена, LED-экран, звук, свет, ферменные конструкции, шатёр или мебель.",
  "Особые требования: брендирование, трансляция, протокол, условия открытой площадки.",
];
