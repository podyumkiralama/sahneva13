...
const NEARBY_CITY_LINKS = {
  adana: ["mersin", "osmaniye", "kahramanmaras"],
  adiyaman: ["sanliurfa", "malatya", "kahramanmaras"],
  afyonkarahisar: ["kutahya", "usak", "isparta"],
  agri: ["van", "igdir", "erzurum"],
  aksaray: ["nevsehir", "konya", "nigde"],
  amasya: ["samsun", "tokat", "corum"],
  ankara: ["eskisehir", "konya", "kirikkale"],
  antalya: ["burdur", "isparta", "mugla"],
  ardahan: ["kars", "artvin", "erzurum"],
  artvin: ["rize", "erzurum", "ardahan"],
  aydin: ["izmir", "mugla", "denizli"],
  balikesir: ["bursa", "canakkale", "manisa"],
  bartin: ["zonguldak", "karabuk", "kastamonu"],
  batman: ["diyarbakir", "mardin", "siirt"],
  bayburt: ["gumushane", "trabzon", "erzurum"],
  bilecik: ["bursa", "eskisehir", "sakarya"],
  bingol: ["elazig", "mus", "diyarbakir"],
  bitlis: ["van", "mus", "siirt"],
  bolu: ["duzce", "sakarya", "ankara"],
  burdur: ["antalya", "isparta", "denizli"],
  bursa: ["yalova", "kocaeli", "balikesir"],
  canakkale: ["balikesir", "tekirdag", "edirne"],
  cankiri: ["ankara", "kastamonu", "corum"],
  corum: ["amasya", "cankiri", "yozgat"],
  denizli: ["aydin", "mugla", "usak"],
  diyarbakir: ["mardin", "batman", "sanliurfa"],
  duzce: ["bolu", "sakarya", "zonguldak"],
  edirne: ["kirklareli", "tekirdag", "canakkale"],
  elazig: ["malatya", "bingol", "tunceli"],
  erzincan: ["erzurum", "sivas", "tunceli"],
  erzurum: ["erzincan", "kars", "agri"],
  eskisehir: ["ankara", "bilecik", "kutahya"],
  gaziantep: ["sanliurfa", "kilis", "kahramanmaras"],
  giresun: ["trabzon", "ordu", "gumushane"],
  gumushane: ["trabzon", "bayburt", "erzincan"],
  hakkari: ["van", "sirnak", "siirt"],
  hatay: ["adana", "osmaniye", "gaziantep"],
  igdir: ["kars", "agri", "van"],
  isparta: ["antalya", "burdur", "konya"],
  istanbul: ["kocaeli", "tekirdag", "yalova"],
  izmir: ["manisa", "aydin", "balikesir"],
  kahramanmaras: ["gaziantep", "adana", "malatya"],
  karabuk: ["zonguldak", "bartin", "kastamonu"],
  karaman: ["konya", "mersin", "antalya"],
  kars: ["erzurum", "ardahan", "igdir"],
  kastamonu: ["sinop", "cankiri", "karabuk"],
  kayseri: ["nevsehir", "nigde", "sivas"],
  kirikkale: ["ankara", "kirsehir", "cankiri"],
  kirklareli: ["edirne", "tekirdag", "istanbul"],
  kirsehir: ["nevsehir", "kirikkale", "aksaray"],
  kilis: ["gaziantep", "hatay", "sanliurfa"],
  kocaeli: ["istanbul", "sakarya", "yalova"],
  konya: ["ankara", "karaman", "aksaray"],
  kutahya: ["eskisehir", "afyonkarahisar", "usak"],
  malatya: ["elazig", "adiyaman", "sivas"],
  manisa: ["izmir", "balikesir", "usak"],
  mardin: ["diyarbakir", "batman", "sanliurfa"],
  mersin: ["adana", "antalya", "karaman"],
  mugla: ["aydin", "antalya", "denizli"],
  mus: ["bitlis", "bingol", "agri"],
  nevsehir: ["kayseri", "kirsehir", "aksaray"],
  nigde: ["kayseri", "aksaray", "konya"],
  ordu: ["giresun", "samsun", "tokat"],
  osmaniye: ["adana", "gaziantep", "kahramanmaras"],
  rize: ["trabzon", "artvin", "erzurum"],
  sakarya: ["kocaeli", "duzce", "bilecik"],
  samsun: ["ordu", "amasya", "sinop"],
  sanliurfa: ["gaziantep", "diyarbakir", "mardin"],
  siirt: ["batman", "sirnak", "bitlis"],
  sinop: ["samsun", "kastamonu", "corum"],
  sirnak: ["mardin", "siirt", "hakkari"],
  sivas: ["kayseri", "tokat", "erzincan"],
  tekirdag: ["istanbul", "kirklareli", "edirne"],
  tokat: ["amasya", "sivas", "ordu"],
  trabzon: ["rize", "giresun", "gumushane"],
  tunceli: ["elazig", "erzincan", "bingol"],
  usak: ["kutahya", "afyonkarahisar", "denizli"],
  van: ["agri", "bitlis", "hakkari"],
  yalova: ["bursa", "kocaeli", "istanbul"],
  yozgat: ["kirsehir", "sivas", "corum"],
  zonguldak: ["bartin", "karabuk", "duzce"],
};
