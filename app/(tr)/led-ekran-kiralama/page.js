        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="p-8 rounded-[2rem] bg-blue-50 text-blue-900 font-bold flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <Link href={WHATSAPP} target="_blank" className="bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-all flex items-center gap-2 flex-shrink-0">
