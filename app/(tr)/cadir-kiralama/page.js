...
export const metadata = {
  ...
  openGraph: {
    ...
    locale: "tr_TR",
    images: [{ url: `${ORIGIN}/img/cadir/hero.webp`, width: 1200, height: 630, alt: "Sahneva Organizasyon etkinlik prodüksiyon görseli" }],
  },
  twitter: {
...
const VIDEO_EMBEDS = [
  { videoId: "tyb1lG9KtiA", title: "Kurulum Videosu • 00:10", uploadDate: "2025-11-17T00:00:00+03:00", description: "Güvenli sabitleme, doğru ekipman ve deneyimli ekip ile hızlı ve kontrollü kurulum." },
...
const FAQ_ITEMS = [
  ...
  { q: "Çadırlar kötü hava koşullarına dayanıklı mı?", a: "Evet, çadırlarımız 90 km/s rüzgar hızına dayanıklıdır. TS EN 13782 standartlarına uygun üretilmiş alüminyum iskelet ve 650 gr/m² UV dayanımlı branda kullanıyoruz. Yağmur oluğu sistemi ile su tahliyesi sorunsuz şekilde sağlanır." },
  { q: "Hangi şehirlerde hizmet veriyorsunuz?", a: "Türkiye'nin 81 ilinde profesyonel çadır kiralama hizmeti sunuyoruz. İstanbul, Ankara, İzmir gibi büyükşehirlerde daha hızlı kurulum süreleri sağlarken, tüm illerde standart hizmet kalitemizi koruyoruz." },
];

const PRICING_ITEMS = [
  { title: "5x5 Çadır", price: "9.000 TL + nakliye", description: "Etkinlik ve davetler için 25 m² pagoda çadır paketi." },
  { title: "4x4 Çadır", price: "8.000 TL + nakliye", description: "Orta ölçekli kurulumlar için 16 m² çadır çözümü." },
  { title: "3x3 Çadır", price: "7.000 TL + nakliye", description: "Kompakt alanlar için 9 m² hızlı kurulum çadırı." },
  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden bg-slate-900 pt-20 min-h-[80vh] 2xl:min-h-[85vh]" aria-labelledby="hero-title">
      <div className="absolute inset-0">
        <Image src={HERO.src} alt={HERO.alt} fill priority loading="eager" fetchPriority="high" className="object-cover" sizes={HERO.sizes} quality={85} blurDataURL={BLUR_DATA_URL} placeholder="blur" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-8">
          <Link href={WHATSAPP} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp üzerinden hemen teklif alın" className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-700 text-white hover:from-green-700 hover:to-emerald-800 hover:scale-105 transform transition-all duration-300 hover:shadow-xl focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-green-400/50 shadow-lg">
            <span aria-hidden="true" className="text-xl mr-2">💬</span>
            <span className="text-base">Hemen Teklif Al – Ücretsiz</span>
          </Link>
          <Link href="#hizmetler" aria-label="Hizmetlerimiz hakkında daha fazla bilgi edinin" className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl border-2 border-white text-white/95 bg-white/10 backdrop-blur-lg hover:bg-white/20 hover:scale-105 transform transition-all duration-300 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-white/50 shadow-lg">
            <span aria-hidden="true" className="text-xl mr-2">🎯</span>
...
function TurnkeyInfrastructure() {
  return (
    <section className="py-16 bg-white" aria-labelledby="anahtar-teslim-baslik">
        ...
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl border border-blue-100 p-8 md:p-10 shadow-xl">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            <div className="flex-1">
              <p className="text-sm font-bold uppercase tracking-widest text-blue-600 mb-3">Anahtar Teslim Operasyon Gücü</p>
              <h2 id="anahtar-teslim-baslik" className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
                “Sıfırdan Kurulum” Odaklı Anahtar Teslim Çadır Altyapısı
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Sadece çadır kiralama değil; iklimlendirme, internet altyapısı ve enerji sistemleriyle{" "}
                <strong className="text-gray-900">uçtan uca saha yönetimi</strong> sunuyoruz.
              </p>
              <ul className="space-y-3 text-gray-700">
                {TURNKEY_FEATURES.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    <span className="mt-2 w-2.5 h-2.5 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex-shrink-0" aria-hidden="true" />
            ...
            <div className="bg-white rounded-3xl border border-blue-100 p-6 shadow-md w-full lg:max-w-xs">
              ...
              <Link
                ...
                className="mt-6 inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 font-bold text-white hover:scale-105 transition-transform duration-300 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-600/50"
              >
      ...
      <div className="container mx-auto px-4">
          ...
          {SERVICES.map((service) => {
            ...
            return (
              <div key={id} className="group">
                <article className="bg-white rounded-3xl border-2 border-gray-100 shadow-xl hover:shadow-2xl p-8 group-hover:scale-105 transition-all duration-500 h-full flex flex-col" aria-labelledby={id}>
        ...
        <div className="text-center mt-12">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:scale-105 transform transition-all duration-300 hover:shadow-xl focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-600/50"
          >
...
function VideoEvidence() {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-blue-50/60" aria-labelledby="gorsel-kanit-baslik">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 id="gorsel-kanit-baslik" className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-gray-900">
            Görsel{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Kanıtlar</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Kurulumdan dijital sahneye uzanan operasyon gücünü öne çıkan görsellerle gösteriyoruz.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {VIDEO_PROOFS.map((proof) => (
            <article key={proof.title} className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500">
              <div className="relative aspect-[16/9]">
                <Image src={proof.src} alt={proof.alt} fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" loading="lazy" />
              </div>
              <div className="p-6 md:p-8">
                <p className="text-sm font-semibold uppercase tracking-wide text-blue-600 mb-3">{proof.title}</p>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {VIDEO_EMBEDS.map((video) => (
            <article key={video.videoId} className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500">
              <div className="relative aspect-[16/9]">
                <VideoEmbed videoId={video.videoId} title={video.title} />
              </div>
              <div className="p-6 md:p-8">
                <p className="text-sm font-semibold uppercase tracking-wide text-blue-600 mb-3">{video.title}</p>
                <p className="text-lg text-gray-700 leading-relaxed">{video.description}</p>
              </div>
            </article>
          ))}
        </div>
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500">
            Fiyatlara KDV dahil değildir. Nakliye ve saha koşullarına göre kurulum detayları proje bazında netleştirilir.
          </p>
        </div>
      </div>
    </section>
...
function PricingSection() {
  return (
    <section className="py-20 bg-gradient-to-b from-blue-50/60 to-white" aria-labelledby="fiyatlar-baslik">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          <h2 id="fiyatlar-baslik" className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6">
            2026 Çadır{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Kiralama</span> Fiyatları
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {PRICING_ITEMS.map((item) => (
            <article key={item.title} className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 flex flex-col gap-4 hover:shadow-2xl transition-all duration-500">
              ...
              <Link
                ...
                className="mt-auto inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-700 px-5 py-3 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:from-green-700 hover:to-emerald-800 hover:shadow-xl focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-green-400/50"
              >
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-600 leading-relaxed">
            Fiyatlara KDV dahil değildir. Nakliye ve saha koşullarına göre kurulum detayları proje bazında netleştirilir. İstanbul içi nakliye genellikle 8.000–12.000 TL arası mesafeye göre değişmektedir; müşteri isterse kendi nakliyesini getirebilir.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-20 bg-white" aria-labelledby="galeri-baslik">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          ...
          <Link
            href="/projeler"
            className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transform transition-all duration-300 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-purple-600/50"
          >
            <span aria-hidden="true" className="text-xl mr-3">📸</span>
...
function StandardsTable() {
  return (
    <section className="py-20 bg-white" aria-labelledby="sahneva-standartlari-baslik">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 id="sahneva-standartlari-baslik" className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-gray-900">
            Sahneva{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Standartları
            </span>
...
function ChallengesSolutions() {
  return (
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white" aria-labelledby="zorluklar-cozumler-baslik">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 id="zorluklar-cozumler-baslik" className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-gray-900">
            Zorluklar{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              ve Çözümler
            </span>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {CHALLENGES.map((item) => (
            <article key={item.title} className="bg-white rounded-3xl border border-gray-200 shadow-lg p-8 hover:shadow-xl transition-all duration-500">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {stats.map((stat, index) => (
            <article key={stat.label} className="text-center group" role="group" aria-labelledby={`cadir-stat-${index}-value`} aria-describedby={`cadir-stat-${index}-label`}>
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 group-hover:bg-white/20 transition-all duration-500 group-hover:scale-105">
                ...
                <h3 id={`cadir-stat-${index}-value`} className="text-4xl md:text-5xl font-black mb-2 text-white drop-shadow-lg">
                  {stat.value}
                </h3>
    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 to-blue-900/95" aria-labelledby="kullanim-alanlari-baslik">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {USE_CASES.map((uc) => (
            <div key={uc.text} className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/30 hover:border-white/50 transition-all duration-500 group hover:scale-105">
        ...
        <div className="text-center mt-12">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl bg-white text-blue-700 hover:scale-105 transform transition-all duration-300 hover:shadow-xl focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-blue-700/50"
          >
            <span aria-hidden="true" className="text-xl mr-3">💬</span>
...
function RelatedServices() {
  const services = [
    { href: "/ses-isik-sistemleri", title: "Ses & Işık Sistemleri", icon: "🎵", desc: "Çadır etkinlikleri için profesyonel ses ve ışık çözümleri" },
    { href: "/sahne-kiralama", title: "Sahne Kiralama", icon: "🛠️", desc: "Konser ve sunumlar için modüler sahne kurulumları" },
    { href: "/masa-sandalye-kiralama", title: "Masa & Sandalye", icon: "🪑", desc: "Konforlu oturma alanları ve tamamlayıcı mobilyalar" },
    { href: "/led-ekran-kiralama", title: "LED Ekran Kiralama", icon: "📺", desc: "Sunum ve sahne için yüksek çözünürlüklü ekranlar" },
  ];
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-100/30" aria-labelledby="ek-hizmetler-baslik">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 id="ek-hizmetler-baslik" className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6">
            Ek{" "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Hizmetler
            </span>
        ...
        <div className="sr-only">
          <p>Bu bölümde çadır kiralama hizmetinizi tamamlayacak ek çözümler listelenmiştir. Kartları seçerek ilgili sayfaya ilerleyebilirsiniz.</p>
        </div>
      </div>
    </section>
  );
                  ...
                  <details className="group rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition-all duration-300 open:border-blue-200 open:bg-blue-50/40">
                    <summary className="flex cursor-pointer list-none items-center justify-between text-lg font-bold text-gray-900">
                      <span className="flex items-center gap-2">
                        <span>🏕️</span> Çadır Kiralama Tam Olarak Nedir?
                      </span>
