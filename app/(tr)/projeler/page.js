  ...
  return (
    <div id="main" className="min-h-screen bg-gradient-to-br from-slate-900 via-[#040817] to-purple-900/20 text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-violet-500/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <section className="relative mx-auto max-w-7xl px-4 pt-16 pb-20">
