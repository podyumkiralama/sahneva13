...
const VIDEO_FILTERS = [
  ...
  },
  {
    ...
    label: "舞台",
    matches: (text) =>
      text.includes("舞台") || text.includes("t台") || text.includes("桁架"),
  },
  {
    id: "tent",
    label: "篷房 / 球形篷",
    matches: (text) => text.includes("篷") || text.includes("穹顶"),
  },
  {
    id: "corporate",
    label: "企业活动",
  ...
  },
  {
    id: "esports",
    label: "电竞",
    matches: (text) => text.includes("电竞") || text.includes("pubg"),
  },
];
    ...
    <>
      <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] px-4 py-3 text-sm text-slate-300 shadow-xl shadow-black/10 backdrop-blur">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2 lg:justify-end" aria-label="视频项目筛选器">
