...
const service = CHINESE_SERVICE_PAGES["corporate-events"];
const canonical = buildCanonical(service.href);

export const metadata = {
  title: service.metaTitle ?? service.title,
  description: service.description,
  alternates: buildAlternatesForPath("/zh/corporate-events"),
  openGraph: {
    title: service.title,
    description: service.description,
    url: canonical,
...
export default function ChineseCorporateEventsPage() {
