...
const service = CHINESE_SERVICE_PAGES["led-screen-rental"];
const canonical = buildCanonical(service.href);

export const metadata = {
  title: service.metaTitle ?? service.title,
  description: service.description,
  alternates: buildAlternatesForPath("/zh/led-screen-rental"),
  openGraph: {
    title: service.title,
    description: service.description,
    url: canonical,
...
export default function ChineseLedScreenRentalPage() {
