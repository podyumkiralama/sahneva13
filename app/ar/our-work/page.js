...
export const metadata = {
  ...
  alternates: buildAlternatesForPath("/ar/our-work"),
  openGraph: {
    type: "website",
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#0B1120] text-white" dir="rtl">
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pb-20 lg:pt-36">
        ...
        <div className="absolute -right-28 top-20 h-72 w-72 rounded-full bg-violet-500/20 blur-3xl" aria-hidden="true" />
        <div className="absolute -left-32 top-36 h-80 w-80 rounded-full bg-violet-400/10 blur-3xl" aria-hidden="true" />
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            ...
            <div className="relative">
              <div className="absolute -inset-4 rounded-[2.5rem] bg-gradient-to-bl from-violet-500/20 to-violet-400/10 blur-2xl" aria-hidden="true" />
      ...
      <section className="relative px-4 pb-20 pt-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] shadow-2xl shadow-violet-950/20 backdrop-blur">
          <div className="relative p-8 md:p-10 lg:p-12">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(139, 92, 246,0.16),transparent_35%)]" aria-hidden="true" />
