  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-violet-900/80 via-purple-800/70 to-violet-950/90"
          aria-hidden="true"
        />
        <div
          className="absolute inset-0 bg-gradient-to-t from-violet-950/80 via-transparent to-purple-900/60"
          aria-hidden="true"
        />
      </div>
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl 2xl:max-w-5xl mx-auto">
            ...
            >
              <span className="text-violet-200">Stage Rental</span> in Turkey
            </h1>
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Stage Rental{" "}
            <span className="text-violet-700">Services in Turkey</span>
          </h2>
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Turnkey{" "}
            <span className="text-violet-700">Packages</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
    ...
    <section className="py-20 bg-white" aria-labelledby="gallery-heading">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Project{" "}
            <span className="text-violet-700">Gallery</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Technical{" "}
            <span className="text-violet-700">Infrastructure</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
    ...
    >
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Where Our{" "}
            <span className="text-violet-300">Stages Shine</span>
          </h2>
    ...
    >
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          ...
          >
            Insights &{" "}
            <span className="text-violet-700">Expert Guidance</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
