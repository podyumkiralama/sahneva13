...
const VIDEO_FILTERS = [
  ...
  },
  {
    ...
    label: "Stage",
    matches: (text) =>
      text.includes("stage") || text.includes("podium") || text.includes("truss"),
  },
  {
    id: "tent",
    label: "Tent / Dome",
    matches: (text) => text.includes("tent") || text.includes("dome"),
  },
  {
    id: "corporate",
    label: "Corporate",
  ...
  },
  {
    id: "esports",
    label: "E-Sports",
    matches: (text) => text.includes("e-sports") || text.includes("pubg"),
  },
];
  ...
  return (
    <article className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.055] p-3 shadow-2xl shadow-black/20 backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-blue-300/35 hover:bg-white/[0.075]">
      ...
      <div className="relative p-5">
        ...
        <ul className="mt-5 flex flex-wrap gap-2" aria-label="Services in this video">
    ...
    <>
      <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.045] px-4 py-3 text-sm text-slate-300 shadow-xl shadow-black/10 backdrop-blur">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2 lg:justify-end" aria-label="Video project filters">
