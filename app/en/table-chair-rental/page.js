...
import { CORPORATE_EVENTS, PROJECTS_COMPLETED, PROVINCES_COUNT } from "@/lib/stats";
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white py-12">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto">
          <div className="flex flex-col items-center text-center p-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
            ...
            <div className="text-xl font-black text-white">Planned</div>
            <div className="text-white/80 text-sm">Layouts & quantities</div>
          </div>
          <div className="flex flex-col items-center text-center p-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
            <span className="text-2xl mb-2" aria-hidden="true">🏆</span>
    ...
    <section className="py-20 bg-white" aria-labelledby="gallery-heading">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          <CaseGallery images={GALLERY_IMAGES} visibleCount={6} locale="en" />
        </div>
