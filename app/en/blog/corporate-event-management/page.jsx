  ...
  return (
    <>
      ...
      >
                ...
                {/* Accessible Table */}
                <div role="region" aria-label="2. Visual Impact: LED Screen Technologies table, scroll horizontally" tabIndex={0} className="not-prose my-8 overflow-x-auto rounded-xl border border-gray-200 shadow-sm">
