...
const service = GERMAN_SERVICE_PAGES["ton-und-lichttechnik"];
const canonical = buildCanonical(service.href);

export const metadata = {
  title: service.metaTitle ?? service.title,
  description: service.metaDescription ?? service.description,
  alternates: buildAlternatesForPath("/de/ton-und-lichttechnik"),
  openGraph: {
    title: service.title,
...
export default function GermanSoundLightPage() {
