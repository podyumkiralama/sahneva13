...
const STATIC_PAGE_META = {
  ...
  "/konser-icin-podyum-kiralama": { lastMod: "2026-03-02T00:00:00+03:00", change: "weekly", pr: 0.9 },
...
const IMAGE_MAP = {
  ...
  "/defile-podyum-kiralama": [
    { loc: "/img/podyum/defile-hero.webp", title: "Defile Podyum Kiralama", caption: "Moda defilesi ve lansman etkinlikleri için T tipi ve U tipi runway podyum çözümleri." },
  ],
  "/konser-icin-podyum-kiralama": [
    { loc: "/img/podyum/konser-hero.webp", title: "Konser İçin Podyum Kiralama", caption: "Konser ve festival organizasyonları için profesyonel ana sahne platformları ve FOH çözümleri." },
  ],
  "/podyum-kiralama-fiyatlari": [
    { loc: "/img/podyum/podyum-kiralama-fiyatlari-hero.webp", title: "Podyum Kiralama Fiyatları 2026", caption: "2026 güncel podyum kiralama fiyatları: m² bazlı hesaplama, halı, skört ve nakliye dahil." },
  ],
  "/led-ekran-kiralama": [
