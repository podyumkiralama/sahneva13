...
const STATIC_PAGE_META = {
  ...
  "/led-ekran-kiralama": { lastMod: `${LED_EKRAN_KIRALAMA_LAST_MODIFIED}T00:00:00+03:00`, change: "weekly", pr: 0.9 },
...
const SERVICE_LASTMOD = {
  "podyum-kiralama": "2026-01-12T00:00:00+03:00",
  "led-ekran-kiralama": `${LED_EKRAN_KIRALAMA_LAST_MODIFIED}T00:00:00+03:00`,
  "ses-isik-sistemleri": "2025-12-22T00:00:00+03:00",
  "sahne-kiralama": "2026-01-08T00:00:00+03:00",
  "cadir-kiralama": "2025-12-18T00:00:00+03:00",
  "masa-sandalye-kiralama": "2025-12-16T00:00:00+03:00",
  "truss-kiralama": "2025-12-20T00:00:00+03:00",
  "kurumsal-organizasyon": "2025-12-12T00:00:00+03:00",
};
...
export function getServiceEntries() {
  ...
  return (services ?? [])
    ...
    .map((p) => ({
      url: abs(p),
      lastMod: toIso(SERVICE_LASTMOD[p.replace(/^\//, "")] ?? "2025-11-18T00:00:00+03:00"),
...
export function getBlogEntries() {
  ...
  return entries
    ...
    .map((e) => {
      ...
      let lastMod = BLOG_PUBLISHED_AT[slug];
      ...
      if (!lastMod) {
        try {
          ...
          try {
            ...
            lastMod = dirStats.mtime.toISOString();
          } catch {
