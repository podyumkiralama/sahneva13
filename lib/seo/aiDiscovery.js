 ...
 *
 * Hem Sahneva'nın standart olmayan yardımcı keşif manifesti hem de /llms.txt
 * bu listeden besleniyor; böylece iki dosya birbirinden kopmuyor. `intent`
 * alanı sayfanın hangi soruya cevap verdiğini anlatır ve iki çıktıda da aynen
 * kullanılır. Gerçek WebMCP araçları tarayıcıda `document.modelContext`
 * üzerinden çalışma anında kaydedilir.
 *
...
export const AI_IMPORTANT_PAGES = Object.freeze([
  ...
  /* ---------- İngilizce hizmet sayfaları ---------- */
  {
    ...
    priority: 0.9,
    intent:
      "Complete event stage systems with decks, roof and truss integration, access, load planning and technical infrastructure for concerts, festivals and corporate productions.",
  },
  {
    ...
    priority: 0.88,
    intent:
      "General modular stage-platform and event-riser rental with size, height, load, surface, access and installation planning; not speaker lecterns.",
  },
  {
    ...
    priority: 0.9,
    intent:
      "Indoor, outdoor and curved LED screen rental in Turkey, including Absen P1.9 fine-pitch panels, circular LED displays, video processing, installation and on-site operation.",
  },
  {
    path: "/en/led-screen-rental-prices",
    title: "LED Screen Rental Prices in Turkey",
    language: "en",
    priority: 0.86,
    intent:
      "Buyer-facing LED screen rental costs in Turkey, including pixel pitch, screen area, processor, installation, technical control, transport and quote comparison.",
  },
  {
  ...
  {
    path: "/en/event-production-istanbul",
    title: "Event Production in Istanbul",
    language: "en",
    priority: 0.86,
    intent:
      "Istanbul venue access and load-in planning, technical crew and end-to-end production management for international organisers.",
  },
  {
    path: "/en/hangar-event-venue-istanbul",
    title: "Hangar Event Venue in Istanbul",
    language: "en",
    priority: 0.84,
    intent:
      "A 90 by 30 metre equipped event hall at Ataturk Airport National Garden with a ready scaffold stage, P1.9 LED, sound, lighting and furniture, plus reconfigurable layouts.",
  },
  {
    path: "/en/av-rental-istanbul",
    title: "AV Rental in Istanbul",
    language: "en",
    priority: 0.84,
    intent:
      "Audio visual equipment rental in Istanbul — sound, microphones, lighting, LED, playback and livestream, as dry hire or with technicians.",
  },
  {
    path: "/en/conference-av-rental-istanbul",
    title: "Conference AV Rental in Istanbul",
    language: "en",
    priority: 0.84,
    intent:
      "Congress and conference AV in Istanbul: simultaneous interpretation, plenary and breakout rooms, speaker management and hybrid delivery.",
  },
  {
  ...
  /* ---------- Türkçe çekirdek hizmet ve karar sayfaları ---------- */
  {
    ...
    title: "Kurumsal Organizasyon ve Etkinlik Prodüksiyonu",
    language: "tr",
    priority: 0.9,
    intent:
  ...
  {
    path: "/podyum-kiralama",
    title: "Podyum Kiralama",
    language: "tr",
    priority: 0.92,
    intent:
      "Konferans, protokol, konser ve geçici zemin uygulamaları için modüler podyum kiralama hizmeti; ölçü, yükseklik, kaplama, erişim ve kurulum planlaması.",
  },
  {
    path: "/led-ekran-kiralama",
    title: "LED Ekran Kiralama",
    language: "tr",
    priority: 0.92,
    intent:
      "Indoor ve outdoor LED ekran, LED wall, video wall, görüntü işlemcisi, reji ve teknik ekip ile ana LED ekran kiralama hizmeti.",
  },
  {
  ...
  },
  {
    ...
    priority: 0.8,
    intent:
      "LED ekran ölçüsü, izleme mesafesi, pixel pitch ve kurulum erişimi için teknik planlama rehberi; fiyat hesabı için ilgili fiyat sayfasına yönlendirir.",
  },
  {
  ...
  /* ---------- İngilizce ek sayfalar ---------- */
  {
    ...
    priority: 0.84,
    intent:
      "Concert and festival show-layout platforms such as drum, backline, FOH and side-stage risers; full roofed stage systems remain under stage rental.",
  },
  {
  ...
  },
  {
    ...
    priority: 0.84,
    intent:
      "Completed concert, corporate event and activation projects with stage, podium, LED screen, sound and lighting references.",
  },
  {
    path: "/en/about",
    title: "About Sahneva",
    ...
    priority: 0.8,
    intent:
      `${YEARS_OF_EXPERIENCE} years of nationwide stage rentals, LED video walls, sound and lighting systems and full-scale event production.`,
  },
  ...
  {
    path: "/de/eventproduktion-tuerkei",
    title: "Event Production Partner in Turkey (German)",
    language: "de",
    priority: 0.9,
    intent:
      "German page for DACH agencies, PCOs and brands looking for a local technical event production partner in Turkey, as main contractor or behind an agency.",
  },
  {
    path: "/de/mice-tuerkei",
    title: "MICE Services in Turkey (German)",
    language: "de",
    priority: 0.74,
    intent:
      "German page on meetings, incentives, conventions and exhibitions in Turkey with local technical production support for PCOs and DMCs.",
  },
  {
    path: "/de/eventproduktion-antalya",
    title: "Event Production in Antalya (German)",
    language: "de",
    priority: 0.72,
    intent:
      "German page on congress hotels and resort events in Antalya, Belek, Kemer and Side with local crew and equipment logistics.",
  },
  {
    path: "/de/podium-preise",
    title: "Podium Rental Prices (German)",
    language: "de",
    priority: 0.7,
    intent:
      "German price page with per-square-metre unit prices, worked examples and what changes the final quote.",
  },
  {
    path: "/de/traversen-mieten",
    title: "Truss Rental (German)",
    language: "de",
    priority: 0.68,
    intent: "German truss, portal, tower and roof structure rental page with load documentation.",
  },
  {
    path: "/de/konzertbuehne-mieten",
    title: "Concert Stage Rental (German)",
    language: "de",
    priority: 0.68,
    intent: "German concert and festival stage page covering main stage, towers, FOH and barriers.",
  },
  {
    path: "/de/laufsteg-mieten",
    title: "Runway Rental (German)",
    language: "de",
    priority: 0.66,
    intent: "German runway page for fashion shows and presentations: form, height, surface and lighting.",
  },
  {
    path: "/de/tische-und-stuehle-mieten",
    title: "Table and Chair Rental (German)",
    language: "de",
    priority: 0.64,
    intent: "German furniture rental page for banquet, conference and lounge setups.",
  },
  {
    path: "/de/regionale-vermietung",
    title: "Regional Event Rental Coverage (German)",
    language: "de",
    priority: 0.64,
    intent: "German city-by-city coverage page for event equipment rental across Turkey.",
  },
  {
    path: "/de/arbeitsweise",
    title: "How Sahneva Works (German)",
    language: "de",
    priority: 0.66,
    intent:
      "German page describing the eight-step production workflow from first enquiry to dismantling.",
  },
  {
    path: "/de/faq",
    title: "Sahneva FAQ (German)",
    language: "de",
    priority: 0.66,
    intent:
      "German answers on stage, LED wall, sound-light and tent rental: build times, crew, logistics, pricing and contract terms.",
  },
  {
    path: "/de/kontakt",
...
/** Yardımcı AI keşif manifestindeki `importantPages` biçimi. */
export function getAiDiscoveryImportantPages() {
