import { findTranslationGroup, LOCALES, HREFLANG_CODE } from "@/lib/i18n/pageEquivalents";
...
export const buildAlternateLanguages = () => {
  // findGroup DEGIL: bu fonksiyon hreflang uretiyor, yedek eslesmesiyle grup
  // secmemeli. Bkz. pageEquivalents.js -> findTranslationGroup.
  const group = findTranslationGroup("/");
  const languages = {};
