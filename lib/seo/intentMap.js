export const INTENT_MAP = {
  ...
  corporate: {
    cluster: "Kurumsal organizasyon şirketleri",
    primaryPage: {
      href: "/kurumsal-organizasyon",
      label: "Kurumsal Organizasyon Şirketleri",
      intent: "Kurumsal organizasyon, kurumsal organizasyon şirketleri ve teknik prodüksiyon ana ticari sayfası",
    },
    supportPages: [
      {
        href: "/blog/kurumsal-organizasyon-nedir-nasil-planlanir",
        label: "Kurumsal Organizasyon Nedir, Nasıl Planlanır?",
        intent: "Kurumsal organizasyon tanımı ve planlama bilgi niyeti (pillar)",
      },
      {
      ...
      },
      {
        ...
        intent: "Kurumsal etkinlik organizasyonu planlama niyeti",
      },
      {
