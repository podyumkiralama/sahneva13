...
export const EN_INTENT_MAP = {
  ...
  eventProductionTurkey: {
    primaryPage: {
      ...
      intent:
        "Event production company in Turkey, event production services Turkey, technical event production and local production partner",
    },
    supportPages: [
  ...
  corporateEventsTurkey: {
    primaryPage: {
      href: "/en/corporate-events",
      intent:
        "Corporate event company Turkey, corporate event management Turkey and production for launches, conferences and galas",
    },
    supportPages: [
      {
        href: "/en/event-production-company-turkey",
        intent: "Broader international event production and agency-partner model",
      },
      {
        href: "/en/blog/corporate-event-planning-guide-2026",
        intent: "Informational corporate event planning research",
      },
    ],
  },
  istanbulProduction: {
  ...
  istanbulEventVenue: {
    primaryPage: {
      ...
      intent:
        "Event venue Istanbul, corporate event venue and fully equipped large hall with a ready technical setup",
    },
    supportPages: [
      {
        href: "/en/event-production-istanbul",
        intent: "City-level crew, production management and load-in planning",
      },
      {
        href: "/en/projects/millet-bahcesi-hangar-event-production",
        intent: "Documented stage, P1.9 LED, audio and seating configuration delivered in the venue",
      },
    ],
  },
  miceTurkey: {
    primaryPage: {
      href: "/en/mice-turkey",
      intent:
        "MICE Turkey technical production for PCOs, DMCs, MICE agencies and conference organizers",
    },
    supportPages: [
  ...
  ledScreen: {
    primaryPage: {
      ...
      intent: "Main LED screen and LED wall rental service, including P1.9 curved and circular LED configurations",
    },
    supportPages: [
      {
      ...
      {
        href: "/en/blog/flexible-vs-curved-led-screens-for-events",
        intent: "Flexible modules versus cabinet-based curved and circular LED construction research",
      },
      {
