...
// VideoObject.about üzerinden bağlanan, kamuya açık kurum ve konu varlıkları.
...
export const REFERENCED_ENTITIES = {
  ...
  teknofest: {
    // Belirli bir TEKNOFEST edisyonunu değil, videonun genel konusunu tanımlar.
    // Event kullanmak tarih ve konum gerektirir; doğrulanmamış bir edisyon üretmeyiz.
    "@type": "Thing",
    name: "TEKNOFEST",
  ...
  sahaExpo: {
    // Belirli bir fuar edisyonu/tarihi olmadığı için zengin sonuç Event'i değildir.
    "@type": "Thing",
    name: "SAHA EXPO",
