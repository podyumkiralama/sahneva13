export const CONTENT_CLUSTERS = {
  ...
  corporate: {
    eyebrow: "Konu kümesi",
    title: "Kurumsal organizasyon etrafındaki içerik kümesi",
    description:
      "Kurumsal organizasyon, kurumsal organizasyon şirketleri ve kurumsal etkinlik organizasyonu niyetlerini tek merkezde topluyoruz: sahne, LED ekran, ses-ışık, teknik keşif ve saha operasyonu.",
