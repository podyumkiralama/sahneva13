export const CONTENT_CLUSTERS = {
  stageRental: {
    eyebrow: "Konu kümesi",
    title: "Sahne kiralama etrafındaki içerik kümesi",
    description:
      "Fiyat, yükseklik, kurulum ve tamamlayıcı teknik çözümleri aynı akışta bağlayarak sahne kiralama sayfasını konu merkezine yerleştiriyoruz.",
  ...
  ledScreen: {
    eyebrow: "Konu kümesi",
    title: "LED ekran kiralama etrafındaki içerik kümesi",
    description:
      "Panel seçimi, izleme mesafesi, içerik akışı ve kurumsal etkinlik ihtiyacını aynı kümede bağlayarak LED ekran sayfasının ticari gücünü artırıyoruz.",
    ...
    guides: [
      {
        ...
        label: "LED Ekran Kiralama Fiyatları 2026",
        anchorText: "LED ekran kiralama fiyatları, m² hesabı ve P1.9 premium LED fiyat farkı",
        intent: "Fiyat araştırması ve teklif öncesi bütçe netleştirme",
      },
      {
      ...
      },
      {
        ...
        anchorText: "etkinlikler için güncel LED ekran teknolojileri",
        intent: "Teknoloji karşılaştırması ve panel seçimi",
      },
      {
        href: "/blog/kurumsal-etkinlik-planlama-rehberi-2026",
        label: "2026 Kurumsal Etkinlik Planlama Rehberi",
        anchorText: "kurumsal etkinliklerde LED ekran planlama akışı",
        intent: "Etkinlik planlama ve görsel prodüksiyon bağlamı",
      },
    ],
    relatedServices: [
      {
        ...
        anchorText: "LED ekranlı kurumsal organizasyon prodüksiyonu",
      ...
      },
      {
        href: "/ses-isik-sistemleri",
        label: "Ses ve Işık Sistemleri",
        anchorText: "LED ekran etkinliğini tamamlayan ses ve ışık çözümleri",
        intent: "Tamamlayıcı teknik altyapı",
      },
    ],
  },
  corporate: {
    eyebrow: "SEO bağlantı merkezi",
    title: "Kurumsal organizasyon ana sayfasını destekleyen içerikler",
    description:
      "Kurumsal organizasyon, kurumsal organizasyon şirketleri ve kurumsal etkinlik organizasyonu niyetlerini; sahne, LED ekran, ses-ışık, teknik reji ve gerçek saha referanslarıyla tek merkezde topluyoruz.",
    primaryIntent: "Kurumsal organizasyon teklifi ve anahtar teslim prodüksiyon",
    secondaryIntent: "Etkinlik planlama, risk yönetimi ve teknik kapsam araştırması",
    funnelStage: "commercial",
    guides: [
      {
  ...
  podium: {
    eyebrow: "Konu kümesi",
    title: "Podyum kiralama etrafındaki içerik kümesi",
    description:
      "Podyum seçimi, etkinlik türü, sahne yüksekliği ve özel platform ihtiyacını aynı bağlamda bağlayarak podyum kiralama sayfasını ticari merkeze alıyoruz.",
    ...
    guides: [
      {
        ...
        anchorText: "doğru podyum kiralama seçimi için teknik rehber",
        intent: "Seçim kriterleri ve teklif hazırlığı",
      },
      {
        href: "/blog/etkinlige-gore-podyum-tercihi",
        label: "Etkinliğe Göre Podyum Tercihi",
        anchorText: "etkinlik türüne göre podyum tercihi",
        intent: "Kullanım senaryosu ve ölçü belirleme",
      },
      {
  ...
  soundLight: {
    eyebrow: "Konu kümesi",
    title: "Ses ve ışık sistemleri etrafındaki içerik kümesi",
    description:
      "Ses, ışık, sahne ve LED ekran ihtiyacını aynı teknik prodüksiyon bağlamında birleştirerek kullanıcıyı doğru hizmet merkezine yönlendiriyoruz.",
