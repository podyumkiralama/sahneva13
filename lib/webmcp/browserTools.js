  ...
  return [
    ...
    },
    {
      ...
      inputSchema: {
        ...
        additionalProperties: false,
        properties: {
          screenType: { type: "string", enum: LED_SCREEN_TYPE_VALUES, default: "standard" },
      ...
      async execute(rawInput, options) {
        ...
        const screenType = enumValue(input, "screenType", LED_SCREEN_TYPE_VALUES, "standard");
