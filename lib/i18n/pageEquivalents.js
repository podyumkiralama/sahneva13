 ...
 *
 * Hem `components/i18n/LanguageSwitcher.client.jsx` hem de hreflang uretimi
 * bu tabloyu okur. Daha once ikisi ayri listelerdi ve sessizce ayrismislardi:
 * switcher /kvkk'dan Ingilizce'ye /en/privacy-policy'ye gonderiyordu, oysa o
 * AYRI bir belge (gizlilik politikasi); /kvkk'nin gercek Ingilizce karsiligi
 * /en/data-protection. Kullanici yanlis dokumana dusuyordu.
 *
 * ---------------------------------------------------------------------------
