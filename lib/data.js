...
export const services = [
  ...
  },
  {
    ...
    desc:
      "Yüksek parlaklık ve netlik sağlayan LED ekranlarımız iç ve dış mekânlara uygundur. P2–P6 çözünürlük aralığındaki paneller, gündüz güneş ışığında dahi net görünürlük sağlar. Profesyonel içerik yönetimi, canlı miksaj ve etkinlik programına göre planlanan teknik destek sunuyoruz.",
    faqs: [
      {
  ...
  {
    slug: "sisme-oyun-parki-kiralama",
    title: "Şişme Oyun Parkı Kiralama",
    excerpt:
      "Kaydırak, engel parkuru, spor ve takım oyunları; proje bazlı kurulum.",
    img: "/img/sisme-oyun-parki/labirent-kalesi.webp",
    ogImage:
    ...
    desc:
      "Okul şenliği, kurum pikniği, festival ve aile etkinlikleri için şişme oyun parkı, kaydırak, engel parkuru ve takım oyunlarını; model seçimi, nakliye, kurulum, saha akışı ve sökümle birlikte planlıyoruz.",
    faqs: [
      {
        q: "Model seçimi nasıl yapılıyor",
        a: "Yaş grubu, katılımcı sayısı, net alan, zemin ve elektrik altyapısı birlikte değerlendirilir."
      },
      {
        q: "Türkiye genelinde kurulum var mı",
        a: "Evet. İstanbul merkezli ekiple Türkiye genelinde proje bazlı lojistik ve kurulum planlanabilir."
      }
    ]
  }
];
...
export const projects = [
  {
    slug: "bayrampasa-adapark-30-agustos-sahne-kurulumu",
    title: "Bayrampaşa Adapark 30 Ağustos 2026 Zafer Bayramı Sahne Kurulumu",
    excerpt:
      "Bayrampaşa Adapark'taki 30 Ağustos Zafer Bayramı etkinliği için sahne, ana ve üst banner LED ekran, podyum, truss ve profesyonel ışık sistemi kuruldu.",
    date: "2026-08-30",
    tags: ["Açık Hava Sahnesi", "LED Ekran", "Podyum", "Truss", "Işık Sistemi"],
    assetDir: "img/projeler/bayrampasa-adapark-30-agustos-sahne-kurulumu",
    cover:
      "/img/projeler/bayrampasa-adapark-30-agustos-sahne-kurulumu/bayrampasa-adapark-30-agustos-ana-sahne-led-ekran.webp",
    updatedAt: "2026-08-30",
    keywords: [
      "Bayrampaşa Adapark sahne kurulumu",
      "30 Ağustos Zafer Bayramı sahnesi",
      "Bayrampaşa sahne kiralama",
      "açık hava sahne kurulumu",
      "LED ekran kiralama",
      "podyum kiralama",
      "truss kiralama",
      "profesyonel ışık sistemi"
    ],
    images: [
      "/img/projeler/bayrampasa-adapark-30-agustos-sahne-kurulumu/bayrampasa-adapark-30-agustos-ana-sahne-led-ekran.webp",
      "/img/projeler/bayrampasa-adapark-30-agustos-sahne-kurulumu/bayrampasa-adapark-sahne-podyum-truss-isik-detayi.webp"
    ],
    priority: 0.82,
  ...
  },
  {
    ...
    excerpt:
      "Gençlik ve Spor Bakanlığı’nın Millet Bahçesi Hangar’da gerçekleştirdiği kapalı alan protokol etkinliğinde LED ekran, sahne, podyum, ses-ışık, truss, teknik reji ve salon düzeni Sahneva koordinasyonunda yönetildi.",
    date: "2026-05-19",
