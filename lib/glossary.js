...
export const GLOSSARY_TERMS = [
  ...
  {
    slug: "isik-yansima-sorunu",
    term: "Moire ve Kamera Uyumu",
    aliases: ["Moire deseni", "Refresh rate"],
    category: "goruntu",
    definition:
      "LED ekranın kamerada dalgalı desen veya bant olarak görünmesi; yenileme hızı ile kamera enstantanesinin uyuşmamasından kaynaklanır.",
    detail:
      "Yayın veya kayıt yapılacak etkinliklerde panelin yenileme hızının yeterli olması (genellikle 3840 Hz ve üzeri) istenir. Ekranın kamerada temiz görünmesi, kayıt alınacak her kurumsal etkinlikte panel seçimini etkileyen kriterdir.",
    related: { href: "/led-ekran-kiralama", label: "LED Ekran Kiralama" },
  },
