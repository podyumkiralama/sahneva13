...
export const GLOSSARY_TERMS = [
  /* ---------------- Sahne ve Platform ---------------- */
  {
    slug: "moduler-podyum",
    term: "Modüler Podyum",
    aliases: ["Modüler sahne paneli", "2×1 podyum paneli", "Stage deck"],
    category: "sahne",
    definition:
  ...
  },
  {
    slug: "etek-perde",
    term: "Etek (Skirting)",
    aliases: ["Sahne eteği", "Podyum skört", "Skirt"],
    category: "sahne",
    definition:
  ...
  },
  {
    ...
    aliases: ["Podyum merdiveni", "Guardrail", "Stage stairs"],
    category: "sahne",
    definition:
  ...
  },
  {
    ...
    related: { href: "/led-ekran-kiralama-fiyatlari", label: "LED Ekran Kiralama Fiyatları" },
  },
  {
  ...
  },
  {
    ...
    related: { href: "/dome-cadir-kiralama", label: "Dome Çadır Kiralama" },
  },
  {
    slug: "ankraj",
    term: "Ankraj",
...
export const SERVICE_GLOSSARY_TERMS = {
  ...
  // dome-cadir bilincli olarak burada degil; dome ayri bir hizmet ve terim
  // /dome-cadir-kiralama sayfasindan cagriliyor.
  "/cadir-kiralama": [
    "pagoda-cadir",
