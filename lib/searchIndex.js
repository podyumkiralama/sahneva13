...
const TR_SERVICE_ROUTES = [
  ...
  { href: "/podyum-kurulum-fiyatlari", label: "Podyum Kurulum Fiyatlari", icon: "\u{1F4B0}", keywords: ["fiyat", "podyum", "kurulum", "maliyet"] },
  { href: "/led-ekran-kiralama-fiyatlari", label: "LED Ekran Kiralama Fiyatlari", icon: "\u{1F4B0}", keywords: ["fiyat", "led", "ekran", "p19"] },
  { href: "/led-ekran-hesaplama", label: "LED Ekran Hesaplama", icon: "\u{1F9EE}", keywords: ["led", "ekran", "hesaplama", "m2", "fiyat"] },
