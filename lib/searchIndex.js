...
const CALCULATOR_ROUTES = [
  ...
  },
  {
    ...
    label: "LED Ekran Ölçüsü Planlama Rehberi",
    description: "Ekran ölçüsü, izleme mesafesi, panel tipi ve kurulum erişimini teknik olarak planlayın.",
    type: "rehber",
    icon: "\u{1F9EE}",
    keywords: ["led", "ekran", "m2", "metrekare", "ölçü", "pixel pitch", "planlama"],
  },
];
