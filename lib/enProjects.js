...

  {
    ...
    gallery: [
      ...
      [
        ...
        "Stage steps, podium surface and platform details in front of the P1.9 LED wall",
      ],
      [
    ...
    body: [
      ...
      "The 16 × 8 m main stage was built on a scaffold system, with its steps, podium surface, truss positions and rear technical access planned around the LED structure. This kept the stage, screen and audience sightlines within one installation plan rather than treating them as separate equipment orders.",
