...
const serviceText = {
  ...
  ru: [
    ...
    ["LED-экраны и видеостены", "Для презентаций, выставок и близкого просмотра доступно 400 м² Absen P1.9; для других условий подбираются внутренние или наружные LED-экраны с видеопроцессором, подачей контента и техническим оператором."],
    ...
    ["Шатры и крытые зоны", "Шатры-пагоды, прозрачные и большепролётные шатры для выставок, фестивалей, зон приёма гостей и закулисных зон."],
    ["Корпоративные мероприятия", "Конференции, презентации брендов, гала-мероприятия и другие корпоративные события с техническим планом, координацией команды и сопровождением программы."],
  ],
};
...
const content = {
  en: {
    ...
    ogLocale: "en_US",
    path: commonPaths.en,
    title: "Event Production Company in Turkey | Local Partner | Sahneva",
    description: "Event production services in Turkey for international agencies: local planning, stage, LED, sound, lighting, crew, logistics, setup and show delivery.",
    ...
    heroTrust:
      "Your trusted technical production partner in Türkiye. From in-person conferences to hybrid event production with remote speakers, we help international brands manage local venues, logistics, access hours and technical requirements with one experienced field team.",
    ...
    seoSupport:
      "For teams comparing an event production company in Turkey, event production services in Turkey, AV rental companies in Istanbul or Antalya, stage and lighting rental, audio-visual services or local technical production support, Sahneva brings the key technical departments into one clear production scope.",
    ...
    servicesHeading: {
      ...
      text: "The production scope can be shaped as complete event infrastructure or selected technical departments for teams looking for stage and lighting rental in Turkey, LED walls, truss, tents and audio-visual rental services.",
    },
    ...
    faq: [
      ...
      ["Is Sahneva an event agency in Turkey or a technical production company?", "Technical production is Sahneva's core service: stage, LED screen, sound, lighting, truss, tent, crew, logistics, installation, show operation and dismantling. We can take the full production scope as main contractor, or work behind an event agency, PCO or DMC that retains client ownership, creative direction, registration or destination management."],
      ...
      ["Do you provide AV rental in Istanbul and Antalya?", "Yes. Istanbul is our base and Antalya our second most active region. For Istanbul, the equipment package, crew models and delivery windows are set out at sahneva.com/en/av-rental-istanbul, and congress or conference room AV including interpretation at sahneva.com/en/conference-av-rental-istanbul. Antalya resort and congress hotel work is covered at sahneva.com/en/event-production-antalya."],
...
const localizedOverrides = {
  ...
  ru: {
    ...
    description: "Sahneva предоставляет сцены, LED-экраны, звук, свет, ферменные конструкции, шатры и техническую команду для международных компаний, агентств и брендов в Турции.",
    eyebrow: "Локальный партнер по мероприятиям в Турции",
    h1: "Технический партнер для международных мероприятий в Турции",
    intro: "Sahneva помогает международным компаниям, европейским агентствам и глобальным брендам проводить мероприятия в Турции. Мы можем взять проект целиком как генеральный подрядчик — от планирования и оборудования до монтажа, работы в день события и демонтажа по одному договору — либо выступить техническим партнёром агентства, PCO или DMC. В этом случае отношения с клиентом и креативное руководство остаются у партнёра. При обеих моделях сцена, LED-экраны, звук, свет, ферменные конструкции, шатры, логистика и монтаж находятся в зоне ответственности одной технической команды.",
    heroTrust:
      "Ваш надёжный технический партнёр в Турции. Одна опытная команда на площадке координирует технические требования, логистику, время доступа и взаимодействие с площадкой.",
    ...
    productionScope: "Объём технических работ",
    ...
    seoSupport:
      "Sahneva работает как технический партнёр международных команд в Турции и помогает планировать сцену, LED-экраны, звук, свет, ферменные конструкции, шатры, состав команды и логистику в Стамбуле, Анталье и других ключевых городах.",
    trust: {
      ...
      cards: [
        ...
        ["Знание площадок и логистики", "Доступ к площадке, гостиничные залы, выставочные центры, часы загрузки, городской трафик и электропитание учитываются до монтажа."],
      ],
    },
    why: { eyebrow: "Почему важен местный партнёр", title: "Международным мероприятиям в Турции нужен местный технический контроль", text: "Для бренда или агентства, приезжающего в Турцию, задача не ограничивается арендой оборудования. Надёжный местный партнёр знает площадки, часы загрузки, городскую логистику, требования к питанию, координацию команды и ход события.", cards: [["Знание площадок и городов", "Доступ к площадке, точки разгрузки, трафик и правила работы конкретной площадки учитываются при планировании."], ["Единая техническая ответственность", "Сцена, LED-экраны, звук, свет, ферменные конструкции и шатры координируются в едином техническом объёме."], ["Международная коммуникация", "Требования, технический план, коммерческое предложение и обновления могут вестись на английском языке."]] },
    ...
    equipment: {
      title: "Профессиональные аудио-, видео-, световые системы и системы управления",
      text: "В зависимости от проекта Sahneva использует профессиональные звуковые, световые, видео- и управляющие системы. Для помещений доступно 400 м² Absen P1.9: малый шаг пикселя подходит для детального контента, презентаций и съёмки с близкого расстояния.",
    },
    ...
    esports: { eyebrow: "Спорт и киберспорт", title: "Сцена, LED и свет для аренных форматов", text: "Для спортивных мероприятий и киберспортивных турниров мы планируем столы игроков, LED-сцены, экраны для зрителей, сценический свет, звук, ферменные конструкции и работу технической команды как единый процесс на площадке." },
    ...
    faqHeading: { eyebrow: "Частые вопросы", title: "Ответы для международных команд", text: "Короткие ответы для агентств и брендов, выбирающих местного технического партнёра в Турции." },
    faq: [["Какие компании организуют крупные корпоративные мероприятия в Турции?", "Крупные корпоративные мероприятия в Турции реализуют продакшн-компании, у которых есть собственный парк сцен, LED-экранов, звукового и светового оборудования, а также монтажные бригады. Sahneva — продакшн-компания со штаб-квартирой в Стамбуле. С 2012 года команда реализовала более 700 проектов в Турции, включая конгрессы, презентации продуктов, дилерские встречи, гала-мероприятия, аренные проекты и киберспортивные турниры. Видео с площадок опубликованы на sahneva.com/ru/our-work."], ["Вы берете проект целиком или только техническую часть?", "Возможны обе модели. Sahneva может взять мероприятие целиком как генеральный подрядчик: планирование, оборудование, монтаж, работа в день события и демонтаж по одному договору, с единой точкой ответственности. Мы также работаем как технический партнёр агентств, PCO и DMC в турецких проектах — в этом случае клиент и креативное направление остаются за агентством, а мы отвечаем за технический процесс на площадке."], ["Вы работаете с международными компаниями в Турции?", "Да. Sahneva работает как местный партнёр компаний, агентств и брендов, которым нужны сцена, LED-экраны, звук, свет, ферменные конструкции, шатры и техническая команда в Турции."], ["Можете ли вы поддержать европейские агентства?", "Да. Мы обеспечиваем коммуникацию на английском, местную логистику, техническое планирование, монтаж, работу в день события и демонтаж в крупных городах Турции."], ["Какие технические услуги вы предоставляете?", "В зависимости от проекта мы предоставляем сцену, подиум, LED-экраны, видеостены, звук, свет, ферменные и подвесные конструкции, шатры, столы игроков, закулисные зоны и техническую команду."], ["Работаете ли вы в Стамбуле, Анталье, Измире, Анкаре и Бодруме?", "Да. Это частые города наших проектов; при понятном объёме работ логистику можно спланировать и для других городов Турции."], ["Поддерживаете ли вы спортивные и киберспортивные события?", "Да. Мы можем планировать аренные проекты, киберспортивные сцены, столы игроков, LED-сцены, свет, звук и работу технической команды."], ["Можно ли скачать профиль компании?", "Да. PDF-профиль Sahneva доступен на этой странице как портфолио и справочный документ."]],
...
export function buildInternationalEventJsonLd(locale) {
  ...
  return {
    ...
    "@graph": [
      { "@type": "WebPage", "@id": webPageId, url: pageUrl, name: pageContent.title, description: pageContent.description, inLanguage: pageContent.htmlLang, isPartOf: { "@id": `${SITE_URL}/#website` }, breadcrumb: { "@id": breadcrumbId }, mainEntity: { "@id": serviceId } },
