...
const content = {
  en: {
    ...
    seoSupport:
      "For teams comparing event production partners in Turkey, AV rental companies in Istanbul or Antalya, stage and lighting rental in Turkey, audio-visual rental services or local technical production support, Sahneva brings the key technical departments into one clear production scope.",
