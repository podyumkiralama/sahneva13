...
const serviceText = {
  ...
  tr: [
    ...
    ["Truss ve rigging sistemleri", "LED, ışık, banner ve sahne mimarisi için truss, scaffold destek, rigging noktaları ve taşıyıcı sistemler planlanır."],
    ["Etkinlik çadırları ve kapalı alanlar", "Pagoda çadır, şeffaf çadır ve büyük açıklıklı çadır sistemleri fuar, festival, ağırlama ve backstage alanları için kurgulanır."],
  ...
  ar: [
    ...
    ["أنظمة Truss وRigging", "هياكل تعليق وحوامل للمسرح والشاشات والإضاءة واللافتات مع مراعاة سلامة التركيب."],
  ...
  ru: [
    ...
    ["Truss и rigging-системы", "Несущие конструкции, точки подвеса и опорные системы для LED, света, баннеров и сценической архитектуры."],
    ["Шатры и крытые зоны", "Пагода, прозрачные шатры и большие шатровые системы для выставок, фестивалей, зон приема гостей и backstage."],
...
const content = {
  en: {
    ...
    description: "Sahneva provides stage, LED screen, sound, lighting, truss, tent and technical event production solutions in Turkey for international companies, agencies and brands.",
  ...
  tr: {
    ...
    h1: "Uluslararası Firmalar İçin Türkiye’de Etkinlik Çözüm Ortağı",
    ...
    trust: {
      ...
      cards: [
        ["İngilizce saha ve proje iletişimi", "Brief, teklif, teknik planlama, kurulum güncellemeleri ve etkinlik günü koordinasyonu İngilizce yürütülebilir."],
    ...
    why: {
      ...
      cards: [
        ...
        ["Uluslararası iletişim", "Brief, teknik planlama, teklif ve prodüksiyon güncellemeleri İngilizce yürütülebilir."],
      ],
    },
    servicesHeading: {
      eyebrow: "Anahtar teslim teknik prodüksiyon",
      title: "Sahne, LED ekran, ses, ışık, truss ve çadır desteği",
      text: "Prodüksiyon kapsamı; ajans brief’i, marka beklentisi ve mekan koşullarına göre komple etkinlik altyapısı veya seçili teknik departmanlar şeklinde planlanabilir.",
    },
    ...
    destination: {
      ...
      text: "İstanbul’un tarihi mekanları ve iş otellerinde, Antalya’nın kongre otelleri ve resort alanlarında, İzmir’in fuar alanlarında, Ankara’nın protokol etkinlik mekanlarında ve Bodrum’un açık hava marka etkinliklerinde teknik prodüksiyon planlaması yapabiliriz. Uluslararası ekipler için bu yerel saha bilgisi, kurulum riskini azaltır ve süreci daha yönetilebilir hale getirir.",
    },
    equipment: {
    ...
    processHeading: {
      ...
      title: "İlk brief’ten saha teslimine kadar net süreç",
    ...
    process: [
      ["Brief ve kapsam", "Etkinlik türü, tarih, şehir, mekan, davetli sayısı, ekran ihtiyacı, sahne formatı ve teknik beklentiler netleştirilir."],
      ["Teknik planlama", "Sahne, LED ekran, ses, ışık, truss, çadır, enerji ve backstage akışı için prodüksiyon planı hazırlanır."],
      ["Lojistik ve kurulum", "Ekipman, ekip, araç, giriş saatleri ve kurulum sırası mekan veya yerel ajansla koordine edilir."],
      ["Etkinlik günü operasyonu", "Teknik ekip; soundcheck, ekran kontrolü, sahne geçişleri ve operasyon desteği için sahada kalır."],
    ...
    faq: [
      ...
      ["Hangi teknik hizmetleri veriyorsunuz?", "Proje kapsamına göre sahne, podyum, LED ekran, video wall, ses, ışık, truss, rigging, çadır, oyuncu masası, backstage ve teknik ekip desteği sunuyoruz."],
      ...
      ["İstanbul ve Antalya’da AV rental / ses görüntü kiralama desteği veriyor musunuz?", "Evet. Sahneva, İstanbul, Antalya ve Türkiye’nin farklı etkinlik destinasyonlarında LED ekran, ses, ışık, sahne, truss ve teknik ekip dahil AV kiralama ve teknik prodüksiyon desteği sağlayabilir."],
      ...
      ["Saha ekibi İngilizce iletişim kurabilir mi?", "Evet. Teknik brief, teklif hazırlığı, kurulum güncellemeleri ve etkinlik günü koordinasyonu uluslararası ekipler için İngilizce yürütülebilir."],
...
const localizedOverrides = {
  ar: {
    ...
    scopeItems: ["مسرح", "شاشات LED", "صوت", "إضاءة", "Truss", "خيام"],
    ...
    seoSupport:
      "تعمل Sahneva كشريك إنتاج تقني في تركيا للفرق الدولية، وتدعم احتياجات المسرح، شاشات LED، الصوت، الإضاءة، truss، الخيام والفريق التقني في إسطنبول، أنطاليا ومدن الفعاليات الرئيسية.",
    trust: {
      ...
      cards: [
        ...
        ["نقطة اتصال واحدة", "يتم تنسيق المسرح، LED، الصوت، الإضاءة، truss، الخيام، الفريق، اللوجستيات والتفكيك ضمن نطاق تقني واحد."],
    ...
    why: {
      ...
      cards: [["معرفة المواقع والمدن", "ندخل الوصول إلى الموقع، نقاط التحميل، حركة المرور وطريقة العمل المحلية ضمن الخطة."], ["مسؤولية تقنية واحدة", "يتم تنسيق المسرح، شاشات LED، الصوت، الإضاءة، truss والخيام ضمن نطاق تقني واحد."], ["تواصل دولي", "يمكن إدارة المتطلبات، التخطيط التقني، العروض والتحديثات باللغة الإنجليزية."]],
    },
    servicesHeading: { eyebrow: "تنفيذ تقني متكامل", title: "دعم المسرح، LED، الصوت، الإضاءة، truss والخيام", text: "يمكن تشكيل نطاق العمل كبنية كاملة للفعالية أو كأقسام تقنية مختارة حسب متطلبات الوكالة، أهداف العلامة وظروف الموقع." },
    ...
    esports: { eyebrow: "فعاليات رياضية وألعاب إلكترونية", title: "دعم المسرح، LED والإضاءة للقاعات الكبيرة", text: "في الفعاليات الرياضية وبطولات الألعاب الإلكترونية يمكننا تخطيط طاولات اللاعبين، الشاشات الكبيرة، شاشات الجمهور، إضاءة المسرح، الصوت، truss وتنسيق الفريق التقني كعملية ميدانية واحدة." },
    profile: { eyebrow: "ملف الشركة", title: "تحميل ملف Sahneva التعريفي", text: "اطلعوا على ملف الشركة الذي يتضمن نماذج من أعمال المسرح، شاشات LED، الصوت، الإضاءة، truss، الفعاليات المؤسسية وإنتاج بطولات الألعاب الإلكترونية." },
    ...
    faq: [["هل تقدمون إنتاج فعاليات للشركات الدولية في تركيا؟", "نعم. تعمل Sahneva كشريك محلي للشركات والوكالات والعلامات التي تحتاج إلى المسرح، LED، الصوت، الإضاءة، truss، الخيام وفريق تقني في تركيا."], ["هل يمكن دعم وكالات أوروبية في تركيا؟", "نعم. نقدم تواصلاً بالإنجليزية، لوجستيات محلية، تخطيطاً تقنياً، تركيباً، تشغيل يوم الحدث وتفكيكاً في المدن التركية الرئيسية."], ["ما الخدمات التقنية المتاحة؟", "حسب نطاق المشروع نوفر المسرح، البوديوم، LED، video wall، الصوت، الإضاءة، truss، rigging، الخيام، طاولات اللاعبين، خلف المسرح والفريق التقني."], ["هل تعملون في إسطنبول وأنطاليا وإزمير وأنقرة وبودروم؟", "نعم. هذه المدن من مواقع العمل المتكررة لدينا، ويمكن تخطيط اللوجستيات لمدن أخرى عند وضوح نطاق المشروع."], ["هل تدعمون الفعاليات الرياضية والألعاب الإلكترونية؟", "نعم. يمكن تخطيط إنتاج القاعات، مسارح الألعاب الإلكترونية، طاولات اللاعبين، شاشات LED الكبيرة، الإضاءة، الصوت والفريق التقني."], ["هل يمكن تحميل ملف الشركة؟", "نعم. ملف Sahneva التعريفي متاح على هذه الصفحة كوثيقة مرجعية قابلة للتحميل."]],
    final: { title: "هل تخططون لفعالية دولية في تركيا؟", text: "شاركوا معنا المدينة، التاريخ، الموقع، عدد الضيوف والتوقعات التقنية. سنعود إليكم بنطاق واضح للمسرح، LED، الصوت، الإضاءة، truss، الخيام والفريق.", contact: "إرسال تفاصيل الفعالية", contactHref: "/ar/contact", whatsapp: "تواصل عبر واتساب" },
  },
  ru: {
    locale: "ru",
    htmlLang: "ru",
    ...
    intro: "Sahneva помогает международным компаниям, европейским агентствам и глобальным брендам проводить мероприятия в Турции. Мы планируем сцену, LED-экраны, звук, свет, truss, шатры, логистику, монтаж, работу в день события и демонтаж одной технической командой.",
    ...
    seoSupport:
      "Sahneva работает как технический производственный партнер в Турции для международных команд и помогает планировать сцену, LED-экраны, звук, свет, truss, шатры, команду и логистику в Стамбуле, Анталье и других ключевых городах.",
    trust: {
      title: "Что беспокоит международные event-команды — и как мы это решаем",
      cards: [
        ...
        ["Одна точка контакта", "Сцена, LED-экраны, звук, свет, truss, шатры, команда, логистика и демонтаж координируются в едином техническом объеме."],
    ...
    destination: {
      title: "Локальный опыт в ключевых event-направлениях Турции",
      text: "Мы поддерживаем события в исторических площадках и бизнес-отелях Стамбула, конгресс-отелях и resort-площадках Антальи, выставочных зонах Измира, протокольных пространствах Анкары и open-air проектах в Бодруме.",
    },
    equipment: {
      title: "Профессиональные AV, звук, свет, видео и системы контроля",
      text: "В зависимости от проекта Sahneva может работать с профессиональным звуком, светом, видео, LED-процессингом и системами контроля для корпоративных событий, выставок, арен и outdoor-проектов.",
    },
    ...
    esports: { eyebrow: "Спорт и киберспорт", title: "Сцена, LED и свет для аренных форматов", text: "Для спортивных мероприятий и киберспортивных турниров мы планируем столы игроков, LED-сцены, экраны для зрителей, сценический свет, звук, truss-конструкции и координацию технической команды как единую полевую операцию." },
    profile: { eyebrow: "Профиль компании", title: "Скачать профиль Sahneva", text: "Ознакомьтесь с профилем компании: сцена, LED-экраны, звук, свет, truss, корпоративные события и киберспортивные проекты." },
    ...
    process: [["Требования и объем", "Уточняем тип события, дату, город, площадку, количество гостей, экраны, формат сцены и технические ожидания."], ["Технический план", "Готовим план по сцене, LED, звуку, свету, truss, шатрам, питанию и backstage-потоку."], ["Логистика и монтаж", "Координируем оборудование, команду, транспорт, часы доступа и очередность монтажа с площадкой или местным агентством."], ["Работа в день события", "Техническая команда остается на площадке для soundcheck, управления экранами, сценических переходов и поддержки."], ["Демонтаж и сдача", "После события демонтаж, загрузка и передача площадки завершаются под той же технической ответственностью."]],
    ...
    faq: [["Вы работаете с международными компаниями в Турции?", "Да. Sahneva работает как локальный партнер для компаний, агентств и брендов, которым нужны сцена, LED, звук, свет, truss, шатры и техническая команда в Турции."], ["Можете ли вы поддержать европейские агентства?", "Да. Мы обеспечиваем коммуникацию на английском, местную логистику, техническое планирование, монтаж, работу в день события и демонтаж в крупных городах Турции."], ["Какие технические услуги вы предоставляете?", "В зависимости от проекта мы предоставляем сцену, подиум, LED, видеостены, звук, свет, truss, rigging, шатры, столы игроков, backstage и техническую команду."], ["Работаете ли вы в Стамбуле, Анталье, Измире, Анкаре и Бодруме?", "Да. Это частые города наших проектов; при ясном объеме работ логистика может быть спланирована и для других городов Турции."], ["Поддерживаете ли вы спортивные и киберспортивные события?", "Да. Мы можем планировать аренные проекты, киберспортивные сцены, столы игроков, LED-сцены, свет, звук и координацию технической команды."], ["Можно ли скачать профиль компании?", "Да. PDF-профиль Sahneva доступен на этой странице как портфолио и справочный документ."]],
    final: { title: "Планируете международное мероприятие в Турции?", text: "Сообщите город, дату, площадку, количество гостей и технические ожидания. Мы подготовим понятный объем работ по сцене, LED, звуку, свету, truss, шатрам и команде.", contact: "Отправить детали события", contactHref: "/ru/contact", whatsapp: "Написать в WhatsApp" },
  },
};
