...
export const EN_GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    detail:
      "Exhibition halls enforce strict build and dismantling windows, and missing them carries penalties. Goods lifts, forklift access and power applications are arranged with the hall management in advance. The technical plan is shaped by the venue's rules.",
  ...
  },
  {
    ...
    aliases: ["Build and dismantling", "Bump-in / bump-out"],
    category: "operations",
    definition:
  ...
  },
  {
    ...
    category: "operations",
    definition:
      "Planning, equipment, installation, event-day operations and dismantling carried by a single team under a single contract.",
    detail:
  ...
  },
  {
    ...
    category: "operations",
    definition:
      "The plan dating every task from survey to dismantling, together with the dependencies between them.",
    detail:
