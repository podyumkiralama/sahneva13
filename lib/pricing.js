...
/**
 * Masa-sandalye hizmet sayfasında herkese açık günlük paket fiyatları.
 * Görünür kartlar ve Product/Offer şeması aynı değerleri buradan okur.
 *
 * Son güncelleme: 24 Ağustos 2026 (yayındaki paket kartlarıyla eşitleme).
 */
export const FURNITURE_PACKAGE_PRICES = Object.freeze({
  "davet-100": 12500,
  "konferans-60": 9800,
  "kokteyl-15": 7200,
});
...
/**
 * Ses ve ışık hizmet sayfasında yayımlanan başlangıç paketleri.
 * Görünür fiyat kartları ile Product/Offer şeması aynı değerleri buradan okur.
 *
 * Son güncelleme: 24 Ağustos 2026 (görünür sayfa ve şema eşitlemesi).
 */
export const SOUND_LIGHT_PACKAGE_PRICES = Object.freeze({
  "ses-konser": 36000,
  "isik-sahne": 54000,
});
