    ...
    <div className="bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-slate-950 px-4 py-16 text-white sm:py-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <p className="text-sm font-black uppercase tracking-[0.18em] text-blue-300">Sahne ve platform sözlüğü</p>
      ...
      <main>
        ...
        <section className="border-y border-slate-200 bg-slate-50 px-4 py-14 sm:py-16" aria-labelledby="pratikte">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.16em] text-blue-700">Pratik kullanım</p>
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 sm:py-16" aria-labelledby="planlama">
          <p className="text-sm font-black uppercase tracking-[0.16em] text-blue-700">Planlama</p>
        ...
        <section className="bg-slate-950 px-4 py-14 text-white sm:py-16" aria-labelledby="uygulama">
          <div className="mx-auto max-w-5xl">
            <p className="text-sm font-black uppercase tracking-[0.16em] text-blue-300">Sahneva uygulama notu</p>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-3">
              {relatedTerms.map((relatedTerm) => (
                <Link key={relatedTerm.slug} href={glossaryHref(relatedTerm.slug)} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:border-blue-400 hover:shadow-md">
