...
export default function TentCalculatorCta() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl rounded-[34px] border border-violet-300/20 bg-gradient-to-br from-violet-500/20 via-white/[0.07] to-slate-950 p-6 shadow-2xl md:p-9">
        <div className="grid gap-7 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <div className="mb-4 inline-flex items-center gap-2 rounded-2xl border border-white/15 bg-white/[0.07] px-4 py-2 text-sm font-black text-violet-100 backdrop-blur-xl">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:max-w-2xl">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3">
                <Ruler className="h-5 w-5 text-violet-200" />
