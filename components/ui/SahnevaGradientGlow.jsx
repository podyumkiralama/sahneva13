export default function SahnevaGradientGlow({
  ...
  const sideGlowClass = isHero
    ? "sahneva-stripe-soft absolute right-[2%] top-[52%] h-36 w-36 rounded-full bg-violet-200/8 blur-3xl md:right-[5%] md:top-[46%] md:h-44 md:w-44"
    : "absolute right-[10%] top-[20%] h-40 w-40 rounded-full bg-violet-300/14 blur-3xl md:h-56 md:w-56";

  const lowerGlowClass = isHero
    ? ""
    : "absolute left-[8%] bottom-[-8%] h-36 w-36 rounded-full bg-violet-500/14 blur-3xl md:left-[16%] md:h-56 md:w-56";
    ...
    return (
      <div className={`${wrapperClass} ${className}`} aria-hidden="true">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 22% 30%, rgba(224,242,254,.55), transparent 18%), radial-gradient(ellipse at 38% 42%, rgba(196, 181, 253,.48), transparent 26%), radial-gradient(ellipse at 58% 36%, rgba(139, 92, 246,.46), transparent 34%), radial-gradient(ellipse at 78% 28%, rgba(99,102,241,.38), transparent 32%), linear-gradient(128deg, rgba(139, 92, 246,.38), rgba(139, 92, 246,.42), rgba(79,70,229,.36), rgba(124,58,237,.28)), conic-gradient(from 220deg at 78% 72%, rgba(255,255,255,.18), rgba(125,211,252,.10), rgba(79,70,229,.08), transparent 90deg)",
  ...
  return (
    <div className={`${wrapperClass} ${className}`} aria-hidden="true">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle_at_20%_25%, rgba(167, 139, 250,.70), transparent 32%), radial-gradient(circle_at_55%_35%, rgba(99,102,241,.75), transparent 34%), radial-gradient(circle_at_80%_20%, rgba(168,85,247,.62), transparent 30%), linear-gradient(135deg, rgba(139, 92, 246,.92), rgba(79,70,229,.92), rgba(124,58,237,.88))",
        }}
      />
