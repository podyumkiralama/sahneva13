...
const COPY = {
  tr: {
    eyebrow: "Teklif öncesi hizmet kapsamı rehberi",
    title: "Etkinliğiniz için hizmet kapsamını netleştirelim",
    intro:
      "Etkinliğiniz için ihtiyaç duyulan sahne, podyum, LED ekran, ses-ışık, truss, çadır ve teknik ekip kapsamını netleştirelim. Bu alan stok veya kesin fiyat onayı vermez; şehir, tarih, mekân, ölçü ve teknik detaylar netleştikçe Sahneva ekibi size uygun teklif hazırlar.",
    capabilityTitle: "Hizmet kapsamını netleştir",
    capabilityText:
      "Sahne, LED ekran, ses-ışık, truss, çadır, kurumsal etkinlik veya e-spor arena prodüksiyonu için gerekli bilgileri toparlayalım.",
    estimateTitle: "Podyum ölçülerini paylaşın",
    estimateText:
      "Podyum bilgisi yalnızca yaklaşık başlangıç rehberidir. Nihai fiyat; lojistik, mekân erişimi, kurulum süresi, ekip, halı/kumaş, merdiven ve teknik detaylara göre Sahneva onayı ile netleşir.",
    ...
    height: "Yükseklik",
    days: "Gün sayısı",
    finishNeeded: "Kaplama / bitiş ihtiyacı",
    submitCapability: "Kapsam bilgisini ilet",
    submitEstimate: "Podyum kapsamını ilet",
    indoor: "İç mekân",
    outdoor: "Dış mekân",
    unknown: "Net değil",
    finishPlaceholder: "Halı, kumaş, merdiven, dekor, zemin notları",
  },
  en: {
    eyebrow: "Pre-quote service scope guide",
