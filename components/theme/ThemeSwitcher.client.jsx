  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        title={`Navbar teması: ${activeOption.label}`}
      >
        <span aria-hidden="true" className="text-lg leading-none">
          {activeOption.icon}
        </span>
        <span className="sr-only">Navbar tema seçimi</span>
      </button>

      {open ? (
        <div
          role="menu"
          aria-label="Navbar tema seçimi"
          ...
          {OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                ...
                {selected ? (
                  <span aria-hidden="true" className="ml-auto text-blue-600 nav-dark:text-blue-300">
                    ✓
                  </span>
                ) : null}
              </button>
