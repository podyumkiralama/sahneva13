...
export default function HeroSection() {
  return (
    <header
      /* DEĞİŞİKLİK BURADA: 
         pt-20 (mobilde navbar yüksekliği kadar boşluk)
         md:pt-32 (masaüstünde daha fazla boşluk)
      */
      className="relative bg-[#0B1120] text-white overflow-hidden pt-20 md:pt-32"
      aria-labelledby="hero-title"
      aria-describedby="hero-desc"
    >
      {/* Background - Arka plan resminin yerleşimi bozulmasın diye burası aynı kalıyor */}
      ...
      <div className="relative z-10">
        {/* Padding değerlerini biraz daha dengeledik */}
        <div className="container mx-auto px-4 pb-16 md:pb-24">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1
              id="hero-title"
              className="mt-6 md:mt-8 text-4xl md:text-6xl lg:text-7xl font-black leading-tight drop-shadow-[0_14px_40px_rgba(0,0,0,0.60)]"
            >
              Sahneva ile{" "}
            ...
            <p
              id="hero-desc"
              className="mt-4 text-base md:text-xl text-white/90 leading-relaxed max-w-3xl mx-auto [text-shadow:0_10px_26px_rgba(0,0,0,0.45)]"
            >
      ...
      {/* Scroll cue */}
      <div
        className="hidden lg:block absolute bottom-8 left-1/2 -translate-x-1/2 pointer-events-none"
        aria-hidden="true"
      >
