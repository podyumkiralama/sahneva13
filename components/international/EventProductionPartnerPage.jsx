...
const VISUAL_REFERENCES = {
  ...
  ru: {
    title: "Реализованные проекты технического обеспечения в Турции",
    text:
    ...
    cards: [
      ...
      ["Главная сцена фестиваля на открытом воздухе", "Большая открытая сцена с LED-экранами, звуковой системой линейного массива, ферменными конструкциями и техническим сопровождением на площадке.", "Фестиваль", "/img/projeler/sifir-atik-festivali/sifir-atik-festivali-ana-sahne-teknik-produksiyon-hero.webp", "Техническое обеспечение главной сцены фестиваля в Турции"],
      ["Техническая зона за сценой", "Схема прохождения сигнала, звуковые стойки, коммутация, электропитание и технический контроль за сценой.", "За сценой", "/img/projeler/sifir-atik-festivali/sifir-atik-festivali-backstage-ses-rack-altyapisi.webp", "Техническая зона за сценой и звуковая инфраструктура"],
      ["LED-экраны и визуальный контент", "Главные и боковые LED-экраны с заранее спланированной подачей контента для видимости бренда и реакции аудитории.", "LED", "/img/projeler/sifir-atik-festivali/sifir-atik-festivali-dev-led-ekran-goruntu-sistemi.webp", "Большой LED-экран и подача визуального контента"],
      ["Звуковая система линейного массива", "Звуковое планирование для большой аудитории, открытых сцен и зон живого выступления.", "Звук", "/img/projeler/sifir-atik-festivali/sifir-atik-festivali-line-array-ses-sistemi-detayi.webp", "Звуковая система линейного массива для открытой сцены"],
    ],
    ...
    wideCards: [
      ...
      ["Спортивные и киберспортивные проекты", "Столы игроков, свет в зале, LED-сцены и работа технической команды объединяются в единый процесс на площадке."],
    ],
  },
};
...
const ARTICLE_SECTIONS = {
  ...
  ru: [
    ["Надёжный местный партнёр для международных компаний", "Турция — востребованное направление для компаний из Европы, Ближнего Востока и других регионов. В Стамбуле, Анталье, Измире, Анкаре и Бодруме проходят выставки, конгрессы, презентации, корпоративные встречи, концерты, спортивные и бренд-мероприятия.", "Sahneva работает как местный технический партнёр и помогает согласовать ожидания международной команды с возможностями площадки."],
    ["Все технические решения у одного подрядчика", "Сцена, подиум, LED-экран, звук, свет, ферменные конструкции, шатры, техническая команда, логистика, монтаж, работа в день события и демонтаж планируются как единый объём работ.", "Это не только аренда оборудования. Команда на площадке отвечает за весь технический процесс."],
    ["Партнёр для европейских агентств и международных брендов", "Мы принимаем проектное задание, определяем объём технических работ, готовим оборудование и план монтажа, управляем работой на площадке и завершаем демонтаж после события.", "Так международная команда не теряет время на поиск отдельных поставщиков в Турции."],
    ["С какими мероприятиями мы работаем", "Международные конгрессы, выставки, корпоративные встречи, презентации брендов, гала-мероприятия, концерты, фестивали, спортивные мероприятия, киберспортивные турниры, аренные проекты, мероприятия на открытом воздухе и публичные события."],
