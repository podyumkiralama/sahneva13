...
const DEFAULT_SERVICES = [
  {
    ...
    Icon: Layers,
    description:
      "Profesyonel moduler sahne sistemleri, truss kiralama ve guvenlik ekipmanlari. Konser, festival, fuar ve ozel etkinlikler icin ozel tasarim sahne cozumleri.",
    image: "/img/hizmet-sahne.webp",
    features: [
      "Moduler sahne (1x1m, 1x2m, 2x2m)",
      "Aluminyum truss sistemleri",
      "Guvenlik bariyerleri",
      "Yuksek kapasiteli platform",
    ],
    href: "/sahne-kiralama",
  },
  {
    ...
    Icon: Layout,
    description:
      "Moduler podyum sistemleri, ozel tasarim podyumlar ve protokol masalari. Toplanti, lansman ve odul torenleri icin profesyonel cozumler.",
    image: "/img/hizmet-podyum.webp",
    features: [
      "Moduler podyum (30-90cm yukseklik)",
      "Protokol masalari",
      "Hali ve yuzey kaplama",
      "Hizli kurulum",
    ],
  ...
  },
  {
    ...
    Icon: Monitor,
    description:
      "Yuksek cozunurluklu indoor/outdoor LED ekran kiralama cozumleri. P2, P3, P4, P5, P6 pixel pitch secenekleri ile her turlu etkinlik icin ideal.",
  ...
  {
    id: "ses-isik",
    title: "Ses Isik Sistemleri",
    Icon: Music,
    description:
      "Profesyonel ses isik sistemleri kiralama hizmeti. Konser, tiyatro, konferans ve ozel etkinlikleriniz icin komple ses ve isik cozumleri.",
    image: "/img/ses-isik/ses-sistemi.webp",
    features: [
      "Line-array ses sistemleri",
      "Kablosuz mikrofonlar",
      "Moving head ve spot isiklar",
      "DMX ve lazer sovlari",
    ],
    href: "/ses-isik-sistemleri",
  },
  {
    id: "cadir",
    title: "Cadir Kiralama",
    Icon: Tent,
    description:
      "Acik hava etkinlikleri icin profesyonel cadir kiralama ve kurulumlari. Su gecirmez, ruzgar dayanikli cadir sistemleri ve aksesuarlari.",
  ...
  },
  {
    ...
    Icon: Users,
    description:
      "Toplanti, davet, dugun ve ozel etkinlikler icin profesyonel masa sandalye kiralama hizmeti. Sik ve konforlu cozumler.",
...
const DEFAULT_DICTIONARY = {
  ...
  sectionDesc:
    "Turkiye geneli sahne kiralama, podyum kiralama, LED ekran kiralama, ses isik sistemleri, truss kiralama, cadir kiralama ve masa sandalye kiralama cozumleri sunuyoruz. Farkli sehirlerdeki ekibimizle tum teknik sureci tek elden planliyoruz.",
  featuresHeading: "Hizmet Ozellikleri",
  ctaLabel: "Detayli Bilgi ve Teklif Al",
  ctaTitle: "Detaylari gor ve fiyat teklifi al",
  imageBadgeLabel: "Profesyonel Cozum",
  imageAlt: "{{title}} hizmeti - Sahneva profesyonel cozumu",
};
